...
func (d *deploymentTester) deploymentComplete() (bool, error) {
	latest, err := d.c.ExtensionsV1beta1().Deployments(d.deployment.Namespace).Get(context.TODO(), d.deployment.Name, metav1.GetOptions{})
	if err != nil {
		return false, err
	}
...
func (d *deploymentTester) getNewReplicaSet() (*v1beta1.ReplicaSet, error) {
	deployment, err := d.c.ExtensionsV1beta1().Deployments(d.deployment.Namespace).Get(context.TODO(), d.deployment.Name, metav1.GetOptions{})
	if err != nil {
