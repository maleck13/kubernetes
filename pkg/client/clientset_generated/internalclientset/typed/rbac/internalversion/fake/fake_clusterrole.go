...
func (c *FakeClusterRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *rbac.ClusterRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoles) List(ctx context.Context, opts v1.ListOptions) (result *rbac.ClusterRoleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoles) Create(ctx context.Context, clusterRole *rbac.ClusterRole) (result *rbac.ClusterRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoles) Update(ctx context.Context, clusterRole *rbac.ClusterRole) (result *rbac.ClusterRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *rbac.ClusterRole, err error) {
	obj, err := c.Fake.
