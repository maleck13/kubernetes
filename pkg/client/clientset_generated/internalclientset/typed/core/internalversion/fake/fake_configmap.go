...
func (c *FakeConfigMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *core.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) List(ctx context.Context, opts v1.ListOptions) (result *core.ConfigMapList, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Create(ctx context.Context, configMap *core.ConfigMap) (result *core.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Update(ctx context.Context, configMap *core.ConfigMap) (result *core.ConfigMap, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core.ConfigMap, err error) {
	obj, err := c.Fake.
