...
func (c *FakeNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *core.Namespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *core.NamespaceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) Create(ctx context.Context, namespace *core.Namespace) (result *core.Namespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) Update(ctx context.Context, namespace *core.Namespace) (result *core.Namespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) UpdateStatus(ctx context.Context, namespace *core.Namespace) (*core.Namespace, error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core.Namespace, err error) {
	obj, err := c.Fake.
