...
func NewKubemarkController(externalClient kubeclient.Interface, externalInformerFactory informers.SharedInformerFactory,
	...
	ctx := context.TODO()
	rcInformer := externalInformerFactory.InformerFor(ctx, &apiv1.ReplicationController{}, newReplicationControllerInformer)
	podInformer := externalInformerFactory.InformerFor(ctx, &apiv1.Pod{}, newPodInformer)
