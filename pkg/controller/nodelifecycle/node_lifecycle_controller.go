...
func NewNodeLifecycleController(podInformer coreinformers.PodInformer,
	...
	nc.podInformerSynced = podInformer.Informer(ctx).HasSynced
	...
	nc.nodeLister = nodeInformer.Lister(ctx)
	nc.nodeInformerSynced = nodeInformer.Informer(ctx).HasSynced

	nc.daemonSetStore = daemonSetInformer.Lister(ctx)
	nc.daemonSetInformerSynced = daemonSetInformer.Informer(ctx).HasSynced
