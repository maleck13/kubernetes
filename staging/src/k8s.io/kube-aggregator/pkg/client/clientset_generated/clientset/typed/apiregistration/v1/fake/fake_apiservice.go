...
func (c *FakeAPIServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *apiregistration_v1.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) List(ctx context.Context, opts v1.ListOptions) (result *apiregistration_v1.APIServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Create(ctx context.Context, aPIService *apiregistration_v1.APIService) (result *apiregistration_v1.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Update(ctx context.Context, aPIService *apiregistration_v1.APIService) (result *apiregistration_v1.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) UpdateStatus(ctx context.Context, aPIService *apiregistration_v1.APIService) (*apiregistration_v1.APIService, error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apiregistration_v1.APIService, err error) {
	obj, err := c.Fake.
