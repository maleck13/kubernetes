...
type APIServiceInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.APIService, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.APIServiceList, error)
...
func (c *aPIServices) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.APIService, err error) {
...
func (c *aPIServices) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.APIServiceList, err error) {
...
func (c *aPIServices) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("apiservices").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *aPIServices) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *aPIServices) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("apiservices").
