...
func (c *FakeAPIServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *apiregistration.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) List(ctx context.Context, opts v1.ListOptions) (result *apiregistration.APIServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Create(ctx context.Context, aPIService *apiregistration.APIService) (result *apiregistration.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Update(ctx context.Context, aPIService *apiregistration.APIService) (result *apiregistration.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) UpdateStatus(ctx context.Context, aPIService *apiregistration.APIService) (*apiregistration.APIService, error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apiregistration.APIService, err error) {
	obj, err := c.Fake.
