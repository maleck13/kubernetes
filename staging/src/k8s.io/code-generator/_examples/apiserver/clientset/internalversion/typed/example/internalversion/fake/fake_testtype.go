...
func (c *FakeTestTypes) Create(ctx context.Context, testType *example.TestType) (result *example.TestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) Update(ctx context.Context, testType *example.TestType) (result *example.TestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) UpdateStatus(ctx context.Context, testType *example.TestType) (*example.TestType, error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *example.TestType, err error) {
	obj, err := c.Fake.
