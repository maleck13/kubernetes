...
func (c *FakeTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *example_v1.TestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *example_v1.TestTypeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) Create(ctx context.Context, testType *example_v1.TestType) (result *example_v1.TestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) Update(ctx context.Context, testType *example_v1.TestType) (result *example_v1.TestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) UpdateStatus(ctx context.Context, testType *example_v1.TestType) (*example_v1.TestType, error) {
	obj, err := c.Fake.
...
func (c *FakeTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *example_v1.TestType, err error) {
	obj, err := c.Fake.
