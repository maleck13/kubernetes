...
type TestTypeInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.TestType, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.TestTypeList, error)
...
func (c *testTypes) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.TestType, err error) {
	result = &v1.TestType{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("testtypes").
...
func (c *testTypes) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.TestTypeList, err error) {
...
func (c *testTypes) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("testtypes").
...
func (c *testTypes) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *testTypes) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("testtypes").
