...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *example_v1.ClusterTestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *example_v1.ClusterTestTypeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) Create(ctx context.Context, clusterTestType *example_v1.ClusterTestType) (result *example_v1.ClusterTestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) Update(ctx context.Context, clusterTestType *example_v1.ClusterTestType) (result *example_v1.ClusterTestType, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *example_v1.ClusterTestType) (*example_v1.ClusterTestType, error) {
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *example_v1.ClusterTestType, err error) {
	obj, err := c.Fake.
