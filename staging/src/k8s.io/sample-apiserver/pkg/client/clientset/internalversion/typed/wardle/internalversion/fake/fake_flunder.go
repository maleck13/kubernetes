...
func (c *FakeFlunders) Get(ctx context.Context, name string, options v1.GetOptions) (result *wardle.Flunder, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlunders) List(ctx context.Context, opts v1.ListOptions) (result *wardle.FlunderList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlunders) Create(ctx context.Context, flunder *wardle.Flunder) (result *wardle.Flunder, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlunders) Update(ctx context.Context, flunder *wardle.Flunder) (result *wardle.Flunder, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlunders) UpdateStatus(ctx context.Context, flunder *wardle.Flunder) (*wardle.Flunder, error) {
	obj, err := c.Fake.
...
func (c *FakeFlunders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *wardle.Flunder, err error) {
	obj, err := c.Fake.
