...
type ExampleInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Example, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ExampleList, error)
...
func (c *examples) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.Example, err error) {
	result = &v1.Example{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ExampleList, err error) {
...
func (c *examples) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *examples) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("examples").
