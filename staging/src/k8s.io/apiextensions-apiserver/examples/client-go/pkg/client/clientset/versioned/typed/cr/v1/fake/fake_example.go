...
func (c *FakeExamples) Get(ctx context.Context, name string, options v1.GetOptions) (result *cr_v1.Example, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) List(ctx context.Context, opts v1.ListOptions) (result *cr_v1.ExampleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) Create(ctx context.Context, example *cr_v1.Example) (result *cr_v1.Example, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) Update(ctx context.Context, example *cr_v1.Example) (result *cr_v1.Example, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *cr_v1.Example, err error) {
	obj, err := c.Fake.
