...
func (c *FakeStorageClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *storage_v1.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) List(ctx context.Context, opts v1.ListOptions) (result *storage_v1.StorageClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Create(ctx context.Context, storageClass *storage_v1.StorageClass) (result *storage_v1.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Update(ctx context.Context, storageClass *storage_v1.StorageClass) (result *storage_v1.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *storage_v1.StorageClass, err error) {
	obj, err := c.Fake.
