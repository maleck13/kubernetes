...
type StorageClassInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.StorageClass, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.StorageClassList, error)
...
func (c *storageClasses) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.StorageClass, err error) {
...
func (c *storageClasses) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.StorageClassList, err error) {
...
func (c *storageClasses) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("storageclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *storageClasses) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *storageClasses) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("storageclasses").
