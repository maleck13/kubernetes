...
type HorizontalPodAutoscalerInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.HorizontalPodAutoscaler, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.HorizontalPodAutoscalerList, error)
...
func (c *horizontalPodAutoscalers) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.HorizontalPodAutoscaler, err error) {
...
func (c *horizontalPodAutoscalers) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.HorizontalPodAutoscalerList, err error) {
...
func (c *horizontalPodAutoscalers) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("horizontalpodautoscalers").
...
func (c *horizontalPodAutoscalers) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *horizontalPodAutoscalers) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("horizontalpodautoscalers").
