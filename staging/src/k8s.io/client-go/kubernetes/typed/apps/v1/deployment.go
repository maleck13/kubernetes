...
type DeploymentInterface interface {
	...
	UpdateStatus(ctx context.Context, obj *v1.Deployment) (*v1.Deployment, error)
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Deployment, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.DeploymentList, error)
...
func (c *deployments) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.Deployment, err error) {
...
func (c *deployments) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.DeploymentList, err error) {
...
func (c *deployments) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("deployments").
...
func (c *deployments) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *deployments) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("deployments").
