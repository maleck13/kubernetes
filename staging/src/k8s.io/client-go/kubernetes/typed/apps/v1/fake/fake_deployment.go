...
func (c *FakeDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *apps_v1.Deployment, err error) {
	obj, err := c.Fake.
...
func (c *FakeDeployments) List(ctx context.Context, opts v1.ListOptions) (result *apps_v1.DeploymentList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDeployments) Create(ctx context.Context, deployment *apps_v1.Deployment) (result *apps_v1.Deployment, err error) {
	obj, err := c.Fake.
...
func (c *FakeDeployments) Update(ctx context.Context, deployment *apps_v1.Deployment) (result *apps_v1.Deployment, err error) {
	obj, err := c.Fake.
...
func (c *FakeDeployments) UpdateStatus(ctx context.Context, deployment *apps_v1.Deployment) (*apps_v1.Deployment, error) {
	obj, err := c.Fake.
...
func (c *FakeDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apps_v1.Deployment, err error) {
	obj, err := c.Fake.
