...
type ControllerRevisionInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.ControllerRevision, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ControllerRevisionList, error)
...
func (c *controllerRevisions) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.ControllerRevision, err error) {
...
func (c *controllerRevisions) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ControllerRevisionList, err error) {
...
func (c *controllerRevisions) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("controllerrevisions").
...
func (c *controllerRevisions) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *controllerRevisions) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("controllerrevisions").
