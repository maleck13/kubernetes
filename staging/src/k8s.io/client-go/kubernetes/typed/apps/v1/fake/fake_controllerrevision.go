...
func (c *FakeControllerRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *apps_v1.ControllerRevision, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) List(ctx context.Context, opts v1.ListOptions) (result *apps_v1.ControllerRevisionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) Create(ctx context.Context, controllerRevision *apps_v1.ControllerRevision) (result *apps_v1.ControllerRevision, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) Update(ctx context.Context, controllerRevision *apps_v1.ControllerRevision) (result *apps_v1.ControllerRevision, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apps_v1.ControllerRevision, err error) {
	obj, err := c.Fake.
