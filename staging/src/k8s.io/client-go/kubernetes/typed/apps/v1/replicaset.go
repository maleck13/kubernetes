...
type ReplicaSetInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.ReplicaSet, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ReplicaSetList, error)
...
func (c *replicaSets) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.ReplicaSet, err error) {
...
func (c *replicaSets) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ReplicaSetList, err error) {
...
func (c *replicaSets) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("replicasets").
...
func (c *replicaSets) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *replicaSets) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("replicasets").
