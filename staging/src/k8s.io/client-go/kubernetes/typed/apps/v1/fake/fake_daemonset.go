...
func (c *FakeDaemonSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *apps_v1.DaemonSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeDaemonSets) List(ctx context.Context, opts v1.ListOptions) (result *apps_v1.DaemonSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDaemonSets) Create(ctx context.Context, daemonSet *apps_v1.DaemonSet) (result *apps_v1.DaemonSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeDaemonSets) Update(ctx context.Context, daemonSet *apps_v1.DaemonSet) (result *apps_v1.DaemonSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeDaemonSets) UpdateStatus(ctx context.Context, daemonSet *apps_v1.DaemonSet) (*apps_v1.DaemonSet, error) {
	obj, err := c.Fake.
...
func (c *FakeDaemonSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apps_v1.DaemonSet, err error) {
	obj, err := c.Fake.
