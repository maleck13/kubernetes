...
type DaemonSetInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.DaemonSet, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.DaemonSetList, error)
...
func (c *daemonSets) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.DaemonSet, err error) {
	result = &v1.DaemonSet{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("daemonsets").
...
func (c *daemonSets) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.DaemonSetList, err error) {
...
func (c *daemonSets) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("daemonsets").
...
func (c *daemonSets) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *daemonSets) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("daemonsets").
