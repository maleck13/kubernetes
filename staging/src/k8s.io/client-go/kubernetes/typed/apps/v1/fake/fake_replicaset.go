...
func (c *FakeReplicaSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *apps_v1.ReplicaSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicaSets) List(ctx context.Context, opts v1.ListOptions) (result *apps_v1.ReplicaSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicaSets) Create(ctx context.Context, replicaSet *apps_v1.ReplicaSet) (result *apps_v1.ReplicaSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicaSets) Update(ctx context.Context, replicaSet *apps_v1.ReplicaSet) (result *apps_v1.ReplicaSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicaSets) UpdateStatus(ctx context.Context, replicaSet *apps_v1.ReplicaSet) (*apps_v1.ReplicaSet, error) {
	obj, err := c.Fake.
...
func (c *FakeReplicaSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apps_v1.ReplicaSet, err error) {
	obj, err := c.Fake.
