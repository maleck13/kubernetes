...
func (c *FakeStatefulSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *apps_v1.StatefulSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) List(ctx context.Context, opts v1.ListOptions) (result *apps_v1.StatefulSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) Create(ctx context.Context, statefulSet *apps_v1.StatefulSet) (result *apps_v1.StatefulSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) Update(ctx context.Context, statefulSet *apps_v1.StatefulSet) (result *apps_v1.StatefulSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) UpdateStatus(ctx context.Context, statefulSet *apps_v1.StatefulSet) (*apps_v1.StatefulSet, error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *apps_v1.StatefulSet, err error) {
	obj, err := c.Fake.
