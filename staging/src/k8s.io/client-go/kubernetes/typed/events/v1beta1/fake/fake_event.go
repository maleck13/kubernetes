...
func (c *FakeEvents) Create(ctx context.Context, event *v1beta1.Event) (result *v1beta1.Event, err error) {
	obj, err := c.Fake.
...
func (c *FakeEvents) Update(ctx context.Context, event *v1beta1.Event) (result *v1beta1.Event, err error) {
	obj, err := c.Fake.
...
func (c *FakeEvents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Event, err error) {
	obj, err := c.Fake.
