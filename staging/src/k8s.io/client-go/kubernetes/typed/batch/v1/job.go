...
type JobInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Job, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.JobList, error)
...
func (c *jobs) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.Job, err error) {
	result = &v1.Job{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jobs").
...
func (c *jobs) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.JobList, err error) {
	result = &v1.JobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jobs").
...
func (c *jobs) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("jobs").
...
func (c *jobs) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *jobs) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("jobs").
