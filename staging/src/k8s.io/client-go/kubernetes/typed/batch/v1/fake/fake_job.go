...
func (c *FakeJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *batch_v1.Job, err error) {
	obj, err := c.Fake.
...
func (c *FakeJobs) List(ctx context.Context, opts v1.ListOptions) (result *batch_v1.JobList, err error) {
	obj, err := c.Fake.
...
func (c *FakeJobs) Create(ctx context.Context, job *batch_v1.Job) (result *batch_v1.Job, err error) {
	obj, err := c.Fake.
...
func (c *FakeJobs) Update(ctx context.Context, job *batch_v1.Job) (result *batch_v1.Job, err error) {
	obj, err := c.Fake.
...
func (c *FakeJobs) UpdateStatus(ctx context.Context, job *batch_v1.Job) (*batch_v1.Job, error) {
	obj, err := c.Fake.
...
func (c *FakeJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *batch_v1.Job, err error) {
	obj, err := c.Fake.
