...
func (c *FakePods) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.PodList, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) Create(ctx context.Context, pod *core_v1.Pod) (result *core_v1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) Update(ctx context.Context, pod *core_v1.Pod) (result *core_v1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) UpdateStatus(ctx context.Context, pod *core_v1.Pod) (*core_v1.Pod, error) {
	obj, err := c.Fake.
...
func (c *FakePods) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Pod, err error) {
	obj, err := c.Fake.
