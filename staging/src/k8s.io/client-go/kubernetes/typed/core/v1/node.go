...
type NodeInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Node, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.NodeList, error)
...
func (c *nodes) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.Node, err error) {
	result = &v1.Node{}
	err = c.client.Get().
		Resource("nodes").
		Name(name).
...
func (c *nodes) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.NodeList, err error) {
	result = &v1.NodeList{}
	err = c.client.Get().
		Resource("nodes").
...
func (c *nodes) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("nodes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *nodes) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *nodes) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("nodes").
