...
func (c *FakeComponentStatuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.ComponentStatus, err error) {
	obj, err := c.Fake.
...
func (c *FakeComponentStatuses) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.ComponentStatusList, err error) {
	obj, err := c.Fake.
...
func (c *FakeComponentStatuses) Create(ctx context.Context, componentStatus *core_v1.ComponentStatus) (result *core_v1.ComponentStatus, err error) {
	obj, err := c.Fake.
...
func (c *FakeComponentStatuses) Update(ctx context.Context, componentStatus *core_v1.ComponentStatus) (result *core_v1.ComponentStatus, err error) {
	obj, err := c.Fake.
...
func (c *FakeComponentStatuses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.ComponentStatus, err error) {
	obj, err := c.Fake.
