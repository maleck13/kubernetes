...
func (c *FakeSecrets) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Secret, err error) {
	obj, err := c.Fake.
...
func (c *FakeSecrets) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.SecretList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSecrets) Create(ctx context.Context, secret *core_v1.Secret) (result *core_v1.Secret, err error) {
	obj, err := c.Fake.
...
func (c *FakeSecrets) Update(ctx context.Context, secret *core_v1.Secret) (result *core_v1.Secret, err error) {
	obj, err := c.Fake.
...
func (c *FakeSecrets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Secret, err error) {
	obj, err := c.Fake.
