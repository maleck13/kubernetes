...
func (c *FakeResourceQuotas) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.ResourceQuota, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.ResourceQuotaList, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) Create(ctx context.Context, resourceQuota *core_v1.ResourceQuota) (result *core_v1.ResourceQuota, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) Update(ctx context.Context, resourceQuota *core_v1.ResourceQuota) (result *core_v1.ResourceQuota, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) UpdateStatus(ctx context.Context, resourceQuota *core_v1.ResourceQuota) (*core_v1.ResourceQuota, error) {
	obj, err := c.Fake.
...
func (c *FakeResourceQuotas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.ResourceQuota, err error) {
	obj, err := c.Fake.
