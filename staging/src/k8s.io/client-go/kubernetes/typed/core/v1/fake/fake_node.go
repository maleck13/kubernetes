...
func (c *FakeNodes) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Node, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodes) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.NodeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodes) Create(ctx context.Context, node *core_v1.Node) (result *core_v1.Node, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodes) Update(ctx context.Context, node *core_v1.Node) (result *core_v1.Node, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodes) UpdateStatus(ctx context.Context, node *core_v1.Node) (*core_v1.Node, error) {
	obj, err := c.Fake.
...
func (c *FakeNodes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Node, err error) {
	obj, err := c.Fake.
