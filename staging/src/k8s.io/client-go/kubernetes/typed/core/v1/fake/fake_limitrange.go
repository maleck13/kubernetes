...
func (c *FakeLimitRanges) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.LimitRange, err error) {
	obj, err := c.Fake.
...
func (c *FakeLimitRanges) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.LimitRangeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLimitRanges) Create(ctx context.Context, limitRange *core_v1.LimitRange) (result *core_v1.LimitRange, err error) {
	obj, err := c.Fake.
...
func (c *FakeLimitRanges) Update(ctx context.Context, limitRange *core_v1.LimitRange) (result *core_v1.LimitRange, err error) {
	obj, err := c.Fake.
...
func (c *FakeLimitRanges) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.LimitRange, err error) {
	obj, err := c.Fake.
