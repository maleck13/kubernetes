...
type ServiceAccountInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.ServiceAccount, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ServiceAccountList, error)
...
func (c *serviceAccounts) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.ServiceAccount, err error) {
...
func (c *serviceAccounts) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ServiceAccountList, err error) {
...
func (c *serviceAccounts) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("serviceaccounts").
...
func (c *serviceAccounts) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *serviceAccounts) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("serviceaccounts").
