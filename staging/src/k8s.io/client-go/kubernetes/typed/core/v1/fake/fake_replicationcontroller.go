...
func (c *FakeReplicationControllers) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.ReplicationController, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.ReplicationControllerList, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) Create(ctx context.Context, replicationController *core_v1.ReplicationController) (result *core_v1.ReplicationController, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) Update(ctx context.Context, replicationController *core_v1.ReplicationController) (result *core_v1.ReplicationController, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) UpdateStatus(ctx context.Context, replicationController *core_v1.ReplicationController) (*core_v1.ReplicationController, error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.ReplicationController, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) GetScale(ctx context.Context, replicationControllerName string, options v1.GetOptions) (result *v1beta1.Scale, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationControllers) UpdateScale(ctx context.Context, replicationControllerName string, scale *v1beta1.Scale) (result *v1beta1.Scale, err error) {
	obj, err := c.Fake.
