...
type ComponentStatusInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.ComponentStatus, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ComponentStatusList, error)
...
func (c *componentStatuses) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.ComponentStatus, err error) {
...
func (c *componentStatuses) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ComponentStatusList, err error) {
...
func (c *componentStatuses) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("componentstatuses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *componentStatuses) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *componentStatuses) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("componentstatuses").
