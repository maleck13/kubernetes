...
func (c *FakePersistentVolumeClaims) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.PersistentVolumeClaim, err error) {
	obj, err := c.Fake.
...
func (c *FakePersistentVolumeClaims) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.PersistentVolumeClaimList, err error) {
	obj, err := c.Fake.
...
func (c *FakePersistentVolumeClaims) Create(ctx context.Context, persistentVolumeClaim *core_v1.PersistentVolumeClaim) (result *core_v1.PersistentVolumeClaim, err error) {
	obj, err := c.Fake.
...
func (c *FakePersistentVolumeClaims) Update(ctx context.Context, persistentVolumeClaim *core_v1.PersistentVolumeClaim) (result *core_v1.PersistentVolumeClaim, err error) {
	obj, err := c.Fake.
...
func (c *FakePersistentVolumeClaims) UpdateStatus(ctx context.Context, persistentVolumeClaim *core_v1.PersistentVolumeClaim) (*core_v1.PersistentVolumeClaim, error) {
	obj, err := c.Fake.
...
func (c *FakePersistentVolumeClaims) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.PersistentVolumeClaim, err error) {
	obj, err := c.Fake.
