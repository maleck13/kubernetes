...
type EndpointsInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Endpoints, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.EndpointsList, error)
...
func (c *endpoints) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.Endpoints, err error) {
	result = &v1.Endpoints{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpoints").
...
func (c *endpoints) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.EndpointsList, err error) {
...
func (c *endpoints) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("endpoints").
...
func (c *endpoints) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *endpoints) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("endpoints").
