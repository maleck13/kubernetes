...
type PodInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Pod, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.PodList, error)
...
func (c *pods) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.PodList, err error) {
	result = &v1.PodList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pods").
...
func (c *pods) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("pods").
...
func (c *pods) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *pods) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("pods").
