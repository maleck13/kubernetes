...
func (c *FakeServiceAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.ServiceAccount, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceAccounts) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.ServiceAccountList, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceAccounts) Create(ctx context.Context, serviceAccount *core_v1.ServiceAccount) (result *core_v1.ServiceAccount, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceAccounts) Update(ctx context.Context, serviceAccount *core_v1.ServiceAccount) (result *core_v1.ServiceAccount, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.ServiceAccount, err error) {
	obj, err := c.Fake.
