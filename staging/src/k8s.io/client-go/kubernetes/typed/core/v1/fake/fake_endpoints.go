...
func (c *FakeEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Endpoints, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.EndpointsList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpoints) Create(ctx context.Context, endpoints *core_v1.Endpoints) (result *core_v1.Endpoints, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpoints) Update(ctx context.Context, endpoints *core_v1.Endpoints) (result *core_v1.Endpoints, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Endpoints, err error) {
	obj, err := c.Fake.
