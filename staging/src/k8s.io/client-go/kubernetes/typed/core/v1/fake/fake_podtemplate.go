...
func (c *FakePodTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.PodTemplate, err error) {
	obj, err := c.Fake.
...
func (c *FakePodTemplates) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.PodTemplateList, err error) {
	obj, err := c.Fake.
...
func (c *FakePodTemplates) Create(ctx context.Context, podTemplate *core_v1.PodTemplate) (result *core_v1.PodTemplate, err error) {
	obj, err := c.Fake.
...
func (c *FakePodTemplates) Update(ctx context.Context, podTemplate *core_v1.PodTemplate) (result *core_v1.PodTemplate, err error) {
	obj, err := c.Fake.
...
func (c *FakePodTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.PodTemplate, err error) {
	obj, err := c.Fake.
