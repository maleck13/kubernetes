...
type PodTemplateInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.PodTemplate, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.PodTemplateList, error)
...
func (c *podTemplates) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.PodTemplate, err error) {
...
func (c *podTemplates) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.PodTemplateList, err error) {
...
func (c *podTemplates) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("podtemplates").
...
func (c *podTemplates) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *podTemplates) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("podtemplates").
