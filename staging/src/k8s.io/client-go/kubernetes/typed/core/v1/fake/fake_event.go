...
func (c *FakeEvents) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Event, err error) {
	obj, err := c.Fake.
...
func (c *FakeEvents) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.EventList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEvents) Create(ctx context.Context, event *core_v1.Event) (result *core_v1.Event, err error) {
	obj, err := c.Fake.
...
func (c *FakeEvents) Update(ctx context.Context, event *core_v1.Event) (result *core_v1.Event, err error) {
	obj, err := c.Fake.
...
func (c *FakeEvents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Event, err error) {
	obj, err := c.Fake.
