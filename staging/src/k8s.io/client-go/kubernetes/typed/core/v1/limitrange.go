...
type LimitRangeInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.LimitRange, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.LimitRangeList, error)
...
func (c *limitRanges) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.LimitRange, err error) {
...
func (c *limitRanges) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.LimitRangeList, err error) {
...
func (c *limitRanges) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("limitranges").
...
func (c *limitRanges) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *limitRanges) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("limitranges").
