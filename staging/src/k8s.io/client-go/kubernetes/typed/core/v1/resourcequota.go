...
type ResourceQuotaInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.ResourceQuota, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ResourceQuotaList, error)
...
func (c *resourceQuotas) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.ResourceQuota, err error) {
...
func (c *resourceQuotas) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ResourceQuotaList, err error) {
...
func (c *resourceQuotas) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("resourcequotas").
...
func (c *resourceQuotas) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *resourceQuotas) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("resourcequotas").
