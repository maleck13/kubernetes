...
type PersistentVolumeInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.PersistentVolume, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.PersistentVolumeList, error)
...
func (c *persistentVolumes) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.PersistentVolume, err error) {
...
func (c *persistentVolumes) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.PersistentVolumeList, err error) {
...
func (c *persistentVolumes) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("persistentvolumes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *persistentVolumes) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *persistentVolumes) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("persistentvolumes").
