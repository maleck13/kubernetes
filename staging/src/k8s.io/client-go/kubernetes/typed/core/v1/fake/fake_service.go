...
func (c *FakeServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Service, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.ServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) Create(ctx context.Context, service *core_v1.Service) (result *core_v1.Service, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) Update(ctx context.Context, service *core_v1.Service) (result *core_v1.Service, err error) {
	obj, err := c.Fake.
...
func (c *FakeServices) UpdateStatus(ctx context.Context, service *core_v1.Service) (*core_v1.Service, error) {
	obj, err := c.Fake.
...
func (c *FakeServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Service, err error) {
	obj, err := c.Fake.
