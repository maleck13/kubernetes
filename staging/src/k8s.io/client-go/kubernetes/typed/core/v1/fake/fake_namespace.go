...
func (c *FakeNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *core_v1.Namespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *core_v1.NamespaceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) Create(ctx context.Context, namespace *core_v1.Namespace) (result *core_v1.Namespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) Update(ctx context.Context, namespace *core_v1.Namespace) (result *core_v1.Namespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) UpdateStatus(ctx context.Context, namespace *core_v1.Namespace) (*core_v1.Namespace, error) {
	obj, err := c.Fake.
...
func (c *FakeNamespaces) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (c *FakeNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *core_v1.Namespace, err error) {
	obj, err := c.Fake.
