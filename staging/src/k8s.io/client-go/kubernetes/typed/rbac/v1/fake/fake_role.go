...
func (c *FakeRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *rbac_v1.Role, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoles) List(ctx context.Context, opts v1.ListOptions) (result *rbac_v1.RoleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoles) Create(ctx context.Context, role *rbac_v1.Role) (result *rbac_v1.Role, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoles) Update(ctx context.Context, role *rbac_v1.Role) (result *rbac_v1.Role, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *rbac_v1.Role, err error) {
	obj, err := c.Fake.
