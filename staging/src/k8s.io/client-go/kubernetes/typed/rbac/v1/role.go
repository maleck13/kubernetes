...
type RoleInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.Role, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.RoleList, error)
...
func (c *roles) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.Role, err error) {
	result = &v1.Role{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("roles").
...
func (c *roles) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.RoleList, err error) {
	result = &v1.RoleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("roles").
...
func (c *roles) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("roles").
...
func (c *roles) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *roles) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("roles").
