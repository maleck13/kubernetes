...
func (c *FakeClusterRoleBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *rbac_v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) List(ctx context.Context, opts v1.ListOptions) (result *rbac_v1.ClusterRoleBindingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) Create(ctx context.Context, clusterRoleBinding *rbac_v1.ClusterRoleBinding) (result *rbac_v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) Update(ctx context.Context, clusterRoleBinding *rbac_v1.ClusterRoleBinding) (result *rbac_v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *rbac_v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
