...
type ClusterRoleInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.ClusterRole, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.ClusterRoleList, error)
...
func (c *clusterRoles) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.ClusterRole, err error) {
...
func (c *clusterRoles) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.ClusterRoleList, err error) {
...
func (c *clusterRoles) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("clusterroles").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterRoles) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *clusterRoles) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("clusterroles").
