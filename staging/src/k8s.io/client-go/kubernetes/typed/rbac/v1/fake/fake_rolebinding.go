...
func (c *FakeRoleBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *rbac_v1.RoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoleBindings) List(ctx context.Context, opts v1.ListOptions) (result *rbac_v1.RoleBindingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoleBindings) Create(ctx context.Context, roleBinding *rbac_v1.RoleBinding) (result *rbac_v1.RoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoleBindings) Update(ctx context.Context, roleBinding *rbac_v1.RoleBinding) (result *rbac_v1.RoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoleBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *rbac_v1.RoleBinding, err error) {
	obj, err := c.Fake.
