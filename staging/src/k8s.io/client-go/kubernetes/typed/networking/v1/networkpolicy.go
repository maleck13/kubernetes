...
type NetworkPolicyInterface interface {
	...
	Get(ctx context.Context, name string, options meta_v1.GetOptions) (*v1.NetworkPolicy, error)
	List(ctx context.Context, opts meta_v1.ListOptions) (*v1.NetworkPolicyList, error)
...
func (c *networkPolicies) Get(ctx context.Context, name string, options meta_v1.GetOptions) (result *v1.NetworkPolicy, err error) {
...
func (c *networkPolicies) List(ctx context.Context, opts meta_v1.ListOptions) (result *v1.NetworkPolicyList, err error) {
...
func (c *networkPolicies) Watch(ctx context.Context, opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("networkpolicies").
...
func (c *networkPolicies) Delete(ctx context.Context, name string, options *meta_v1.DeleteOptions) error {
...
func (c *networkPolicies) DeleteCollection(ctx context.Context, options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("networkpolicies").
