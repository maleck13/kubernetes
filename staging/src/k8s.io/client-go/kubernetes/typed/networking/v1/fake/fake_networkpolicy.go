...
func (c *FakeNetworkPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *networking_v1.NetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) List(ctx context.Context, opts v1.ListOptions) (result *networking_v1.NetworkPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) Create(ctx context.Context, networkPolicy *networking_v1.NetworkPolicy) (result *networking_v1.NetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) Update(ctx context.Context, networkPolicy *networking_v1.NetworkPolicy) (result *networking_v1.NetworkPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *networking_v1.NetworkPolicy, err error) {
	obj, err := c.Fake.
