...
type DeploymentInformer interface {
	...
	Lister(ctx context.Context) v1.DeploymentLister
}
...
func (f *deploymentInformer) Informer(ctx context.Context) cache.SharedIndexInformer {
	return f.factory.InformerFor(ctx, &apps_v1.Deployment{}, f.defaultInformer)
}

func (f *deploymentInformer) Lister(ctx context.Context) v1.DeploymentLister {
	return v1.NewDeploymentLister(f.Informer(ctx).GetIndexer())
}
