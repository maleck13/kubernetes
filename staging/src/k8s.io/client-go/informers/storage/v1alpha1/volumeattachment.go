...
type VolumeAttachmentInformer interface {
	...
	Lister(ctx context.Context) v1alpha1.VolumeAttachmentLister
}
...
func (f *volumeAttachmentInformer) Informer(ctx context.Context) cache.SharedIndexInformer {
	return f.factory.InformerFor(ctx, &storage_v1alpha1.VolumeAttachment{}, f.defaultInformer)
}

func (f *volumeAttachmentInformer) Lister(ctx context.Context) v1alpha1.VolumeAttachmentLister {
	return v1alpha1.NewVolumeAttachmentLister(f.Informer(ctx).GetIndexer())
}
