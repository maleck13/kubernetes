...
type ClusterRoleBindingInformer interface {
	...
	Lister(ctx context.Context) v1.ClusterRoleBindingLister
}
...
func (f *clusterRoleBindingInformer) Informer(ctx context.Context) cache.SharedIndexInformer {
	return f.factory.InformerFor(ctx, &rbac_v1.ClusterRoleBinding{}, f.defaultInformer)
}

func (f *clusterRoleBindingInformer) Lister(ctx context.Context) v1.ClusterRoleBindingLister {
	return v1.NewClusterRoleBindingLister(f.Informer(ctx).GetIndexer())
}
