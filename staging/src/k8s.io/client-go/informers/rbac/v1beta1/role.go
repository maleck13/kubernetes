...
type RoleInformer interface {
	...
	Lister(ctx context.Context) v1beta1.RoleLister
}
...
func (f *roleInformer) Informer(ctx context.Context) cache.SharedIndexInformer {
	return f.factory.InformerFor(ctx, &rbac_v1beta1.Role{}, f.defaultInformer)
}

func (f *roleInformer) Lister(ctx context.Context) v1beta1.RoleLister {
	return v1beta1.NewRoleLister(f.Informer(ctx).GetIndexer())
}
